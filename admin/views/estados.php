...
<div class="busca">
    <form action="?pg=estados&act=buscar" method="post">
        <input name="busca" value="Busca por estados..." onBlur="if(this.value == ''){ this.value='Busca por estados...' }" onFocus="if(this.value == 'Busca por estados...'){ this.value='' }" />
        <input type="submit" class="busca-ok" value="" />
    </form>            
</div>

<div class="add">
    <a href="?pg=estados&act=cadastrar"><img src="static/images/add_23.jpg" alt="NOVO ESTADO" title="NOVO ESTADO" />NOVO ESTADO</a>
</div>
...
<div id="listagem">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="<?php echo $class;?>">
        ...
        <td width="25%"><?php echo $row->uf; ?></td>
        <td width="16%" align="center" class="last">
            <a href="?pg=estados&act=cadastrar&id=<?php echo $row->id;?>"><img src="static/images/editar.png" border="0" class="tTip" title="Editar" alt="Editar" id="editar1"/></a>
            <a class="bt-excluir" href="?pg=estados&act=deletar&id=<?php echo $row->id;?>"><img src="static/images/excluir.png" border="0" title="Excluir" alt="Excluir" /></a>
        </td>
      </tr>
    ...
    <tr class="selection">
        <td colspan="6">
            ...
            <form action="?pg=estados&act=deletar" id="form_selecionados" method="post">               
