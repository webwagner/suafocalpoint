...
<table style="width: 100%; background: #e6f3fc url('static/img/top-email-bg.jpg') repeat-x; text-align: justify; height: 212px;" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td>
            <table style="width: 100%; background: url('static/img/top-email-frase.png') top left no-repeat;" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td>
                        <table style="width: 960px; margin: 0 auto;" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td style="float: left; width: 100%;" align="center">
                                    <img src="static/img/top-email-logo.jpg" alt="SuaFocalpoint" />
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td align="center">
                                    <img src="static/img/top-email-frase2.jpg" alt="Apresentando uma nova e poderosa ferramenta para corretores de imóveis!" />
                                </td>
                            </tr>
                        </table>
                    </td>
...
<table style="background-color: #e6f3fc; width: 100%;" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td>
            <table width="920" style="margin: 20px auto 30px auto; text-align: justify; border: 1px solid #e1dfdd; background-color: #fff; padding: 0 30px;" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="color: #251f45; font-family: Arial; font-size: 17px; line-height: 23px;">
                        ...
                        <p style="margin-bottom: 40px;">
                            <img align="right" style="margin-left: 20px;" src="static/img/img1.jpg" alt="Sua Focalpoint" />
                        ...
                        <p style="margin-bottom: 40px;">
                            <img style="margin-right: 20px;" align="left" src="static/img/img2.jpg" alt="Sua Focalpoint" />
                        ...
                        <p style="margin-bottom: 40px;">
                            <img align="right" style="margin-left: 20px;" src="static/img/img3.jpg" alt="Sua Focalpoint" />
                        ...
                        <p style="margin-bottom: 40px;">
                            ...
                            <img style="margin-right: 20px;" align="left" src="static/img/img4.jpg" alt="Sua Focalpoint" />
...
<table style=" width: 100%; background: url('static/img/bottom-email.jpg') repeat-x; height: 88px;" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td>
            <table width="960" style="background: url('static/img/bottom-email.jpg') repeat-x; height: 88px; margin: 0 auto;" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td>
                        <p style="float: left; width: 100%; text-align: center;">
                            <a target="_BLANK" style="font-size: 18px; font-family: Arial; color: #251f45; text-decoration: none;" href="http://www.suafocalpoint.com"><img src="static/img/bottom-email2.jpg" alt="suafocalpoint.com" /></a>
                        </p>
                        <p style="float: left; width: 100%; text-align: center; margin-top: 1px;">
                            <img src="static/img/bottom-email1.jpg" alt="RIO DE JANEIRO (21) 2429-1000 SÃO PAULO (11) 3819-4366 BRASÍLIA (61) 9829-3019" />
                        </p>
                    </td>
                </tr>
            </table>
